...
# ... (código de inicialização e exibição do histórico é o mesmo)
...
if prompt := st.chat_input("Sua mensagem:"):
    ...
    if supabase:
        try:
            # --- LÓGICA DE INSERT 2.0 ---
            # Inserimos a pergunta e já pedimos o ID de volta
        ...
        with st.spinner("Pensando..."):
            ...
            try:
                ...
                if supabase and new_log_id:
                    try:
                        # --- LÓGICA DE UPDATE 2.0 ---
                        # Atualizamos a linha usando o ID exato que acabamos de criar
